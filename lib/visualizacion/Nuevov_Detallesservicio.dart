import 'package:aplicacion_mecanico/componentes/shoCotizacionesNew.dart';
import 'package:aplicacion_mecanico/componentes/showD_NewGatos.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            toolbarHeight: 70,
            centerTitle: true,
            title: const Text('Detalles de Servicios'),
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                  ...
                                  elevation: 10,
                                  shadowColor:
                                      Color.fromARGB(255, 149, 179, 255),
